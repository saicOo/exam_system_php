...
if(isset($_POST['exam_id'])){
  $revision = new Revision;
      $exam->updateStatusExam($_POST['exam_id'],0);
...
//   $revision = new Revision;
//       $exam->updateStatusExam($_COOKIE['exam_id'],0);
...
<div class="card text-white bg-dark">
  ...
  <div class="form-group mx-sm-3 mb-2" style="width: 60%;">
    ...
    <input type="text" class="form-control" name="message" id="inputSubscribe" placeholder="Subscribe..." style="width: 100%;" required>
  </div>
  <button type="submit" name="subscribe" class="btn btn-warning mb-2">Subscribe</button>
</form>
  </div>
</div>
